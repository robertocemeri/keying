...
1. In the `keying` repo: `Settings → Pages`.
2. Source: "Deploy from a branch."
3. Branch: `main` · Folder: `/website`.
4. Save. Your site is live at `https://<user>.github.io/keying/`.
...
- [ ] Search/replace `https://keying.app` with your real domain in `index.html`, `privacy.html`, `sitemap.xml`, and any meta tags.
- [ ] If you don't have a domain yet: leaving canonicals pointed at `keying.app` is fine for staging — but search engines will get confused, so don't index until you've picked one.
